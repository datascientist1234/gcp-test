...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        if np.sum([roi_gray])!=0:
            ...
            cv2.putText(frame,label,label_position,cv2.FONT_HERSHEY_SIMPLEX,1,(0,255,0),3)  # putText is used to draw a detected emotion on image
            cv2.putText(frame,'Press q to exit',(400,450),cv2.FONT_HERSHEY_SIMPLEX,1,(0, 0, 255),2)
        else:
            cv2.putText(frame,'No Faces',(100,150),cv2.FONT_HERSHEY_SIMPLEX,1,(0, 0, 255),4.)
            cv2.putText(frame,'Press q to exit',(400,450),cv2.FONT_HERSHEY_SIMPLEX,1,(0, 0, 255),2)
